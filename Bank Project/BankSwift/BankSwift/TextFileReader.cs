namespace Bank.FileReader
{
    using Bank.MoveFile;
    using Bank.SwiftParse;
    using Bank.SwiftParse.ApplicationHeaderBlock;
    using Bank.SwiftParse.UserHeaderBlock;
    using System;
    ...
    public class TextFileReader
    {
        ...
        public string FileReader(string fileName)
        {
            ...
            string successFolderPath = @$"C:\Users\Albert Khurshudyan\Desktop\softuni-windows\Bank Project\BankSwift\SUCCESS\{fileName}";
            string failedFolderPath = @$"C:\Users\Albert Khurshudyan\Desktop\softuni-windows\Bank Project\BankSwift\FAILED\{fileName}";
